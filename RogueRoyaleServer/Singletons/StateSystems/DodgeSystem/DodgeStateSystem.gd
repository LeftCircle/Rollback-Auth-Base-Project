...
func queue_entity(frame : int, entity) -> void:
	...
	var stamina : S_Stamina = entity.get_component('Stamina')
...
func _on_entity_registered(frame : int, entity) -> void:
	...
	#var animations : AnimationPlayer = entity.animations
	#animations.play("Dodge")
	#animations.seek(0, false, true)
	var animation_tree : RollbackAnimationTree = entity.animation_tree
	animation_tree.start_playing_node_at_position("Dodge", entity.input_vector)
	var input_queue : S_InputQueue = entity.get_component("InputQueue")
...
func execute(frame : int) -> void:
	...
	for entity in registered_entities:
		...
		var dodge_component = entity.get_component("Dodge")
		var input_queue : S_InputQueue = entity.get_component("InputQueue")
		var animation_tree : RollbackAnimationTree = entity.animation_tree
		...
		dodge_component.netcode.send_to_clients()
