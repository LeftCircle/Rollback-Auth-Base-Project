...
func test_shield_advances_to_attack_1():
	...
	var shield = shield_and_char[1].get_secondary_weapon()
...
func _is_shield_in_state(shield : C_StartShield, state_to_check : int) -> bool:
...
func _execute_shield_for_10_frames(shield : C_StartShield) -> void:
