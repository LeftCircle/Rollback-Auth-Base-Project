extends TimerData
class_name ComponentLockerData

var class_id_to_lock : int
var class_instance_to_lock : int

func set_data_with_obj(other_obj): 
	class_id_to_lock = other_obj.class_id_to_lock
	class_instance_to_lock = other_obj.class_instance_to_lock
...
func set_obj_with_data(other_obj): 
	other_obj.class_id_to_lock = class_id_to_lock
	other_obj.class_instance_to_lock = class_instance_to_lock
...
func matches(other_obj) -> bool: 
	return (
	(ModularDataComparer.compare_values(class_id_to_lock, other_obj.class_id_to_lock) == true) and
	(ModularDataComparer.compare_values(class_instance_to_lock, other_obj.class_instance_to_lock) == true) and
