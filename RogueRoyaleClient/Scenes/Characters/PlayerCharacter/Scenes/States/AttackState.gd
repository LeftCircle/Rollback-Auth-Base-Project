...
#	Logging.log_line("Combo attack to occur on frame " + str(frame))
...
#	var input_queue = entity.get_component("InputQueue")
#	input_queue.set_data_to(frame, input_queue_copy_data)
